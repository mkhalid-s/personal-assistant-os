...
- A SQLite-first retrieval trace contract in `graphrag.py` surfaced through `myos context --graph`, returning cited chunks and one-hop relationship explanations.
