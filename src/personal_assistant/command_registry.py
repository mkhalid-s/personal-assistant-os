...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("intent", "workflow", "local_write", "plan_intent", "Create, list, and inspect first-class assistant intents.", subcommands=("create", "list", "show", "evidence"), examples=("myos intent create 'Resolve launch risk'",)),
    CommandSpec("plan", "workflow", "local_write", "plan_intent", "Create and inspect intent-tied plans.", subcommands=("create", "show"), examples=("myos plan create --intent 1",)),
    ...
    CommandSpec("factory", "workflow", "approval_gated", "factory_run", "Run review-first AI factory workflows.", subcommands=("start", "status", "review", "approve", "policy", "learn", "insights", "--executor"), examples=("myos factory start --intent 1", "myos factory start --intent 1 --pack software_delivery --executor zero"), requires_confirmation=True),
    ...
    CommandSpec("execution-receipt", "expert", "read_only", "approval_review", "Inspect execution receipts.", subcommands=("list", "show"), examples=("myos execution-receipt list",)),
    ...
    CommandSpec("autopilot-status", "expert", "read_only", "daily_brief", "Show autopilot run state.", examples=("myos autopilot-status",)),
    ...
    CommandSpec("doctor", "diagnostic", "diagnostic", "system_health", "Show local system and connector health.", examples=("myos doctor --strict",)),
    ...
    CommandSpec("release-check", "diagnostic", "diagnostic", "system_health", "Run release readiness checks.", examples=("myos release-check --strict",)),
