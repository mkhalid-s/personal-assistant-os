...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("approve", "daily", "approval_gated", "approval_review", "Review and optionally execute approval-gated actions.", subcommands=("--list", "--action", "--execute"), examples=("myos approve --list", "myos approve --list --json"), requires_confirmation=True),
